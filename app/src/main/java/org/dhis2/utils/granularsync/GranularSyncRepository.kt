...
import org.dhis2.R
import org.dhis2.bindings.categoryOptionCombo
import org.dhis2.bindings.countEventImportConflicts
import org.dhis2.bindings.countTeiImportConflicts
import org.dhis2.bindings.dataElement
import org.dhis2.bindings.dataSetInstanceSummaries
import org.dhis2.bindings.dataSetInstancesBy
import org.dhis2.bindings.dataSetSummaryBy
import org.dhis2.bindings.dataValueConflicts
import org.dhis2.bindings.dataValueConflictsBy
import org.dhis2.bindings.enrollment
import org.dhis2.bindings.enrollmentImportConflicts
import org.dhis2.bindings.enrollmentInProgram
import org.dhis2.bindings.event
import org.dhis2.bindings.eventImportConflictsBy
import org.dhis2.bindings.eventsBy
import org.dhis2.bindings.isStockProgram
import org.dhis2.bindings.observeDataSetInstancesBy
import org.dhis2.bindings.observeEvent
import org.dhis2.bindings.observeProgram
import org.dhis2.bindings.observeTei
import org.dhis2.bindings.organisationUnit
import org.dhis2.bindings.period
...
import org.dhis2.bindings.teiAttribute
import org.dhis2.bindings.teiImportConflictsBy
import org.dhis2.bindings.teiMainAttributes
import org.dhis2.bindings.teisBy
import org.dhis2.bindings.trackedEntityType
...
class GranularSyncRepository(
    ...
    private fun errorWarningDescriptionLabel(
        errorCount: Int,
        warningCount: Int,
    ) = when {
        errorCount > 0 && warningCount > 0 -> {
            val errorLabel =
                resourceManager
                    .getPlural(R.plurals.error_count_label, errorCount)
                    .format(errorCount)
            val warningLabel =
                resourceManager
    ...
    private fun mapTeiToSyncStatusItem(
        ...
        val label =
            teiMainAttribute.firstOrNull()?.let { (attributeName, value) ->
                "$attributeName: $value"
            } ?: trackedEntityTypeName!!

        val activeEnrollmentInProgram =
    ...
    private fun mapEventToSyncStatusItem(
        ...
        val description =
            when (event.aggregatedSyncState()) {
                State.WARNING,
                State.ERROR,
                -> {
                    errorWarningDescriptionLabel(
    ...
    private fun getNumberOfConflictsForTei(teiUid: String): Int = d2.countTeiImportConflicts(teiUid)

    private fun getNumberOfConflictsForEvent(eventUid: String): Int = d2.countEventImportConflicts(eventUid)
    ...
    private fun getEnrollmentItemsWithStates(
        ...
        val conflicts =
            if (states.contains(State.ERROR) || states.contains(State.WARNING)) {
                        ...
                        when {
                            trackerImportConflict.trackedEntityAttribute() != null -> {
                                ...
                                SyncStatusItem(
                                    ...
                                    state =
                                        trackerImportConflict.status()?.toState()
        ...
        d2
            .dataSetInstancesBy(
                ...
                if (
                    ...
                    SyncStatusItem(
                        type =
                            SyncStatusType.DataSetInstance(
                                dataSetUid,
