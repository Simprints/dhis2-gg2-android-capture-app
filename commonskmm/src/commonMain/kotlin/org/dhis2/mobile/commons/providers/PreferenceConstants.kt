...
// Base behavior: develop-eyeseetea removed this together with BasicPreferenceProvider (1bb3974ca1).
// Simprints behavior: the biometrics surface still reads its flattened configuration through
// BasicPreferenceProviderImpl, which stores it in this separate SharedPreferences file.
