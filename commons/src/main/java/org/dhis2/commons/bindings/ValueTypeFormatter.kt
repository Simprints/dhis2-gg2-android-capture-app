...
private fun formatInteger(value: String): String? = value.toDoubleOrNull()?.toInt()?.toString()

private fun formatDecimal(value: String): String? = value.toDoubleOrNull()?.toString()
